    ...
    data: [
      {
        ...
        years: "January 2025 - August 2026",
      },
      {
        company: "Symph",
        role: "Web Developer - Intern",
        years: "August 2024 - December 2024",
      },
      {
        company: "Codebility",
        role: "Codev - Intern",
        years: "April 2024 - August 2024",
      },
      {
...
const About = () => {
  ...
  return (
    <section className='xl:h-[860px] py-12 xl:py-24 mb-24 '>
              ...
              <div className='text-lg mt-12 xl:mt-8'>
                <TabsContent value='personal'>
                  <div className='text-center xl:text-left'>
                    <h3 className=' h4 md:h3 mb-4'>
                      Unmatched Quality Service
                    </h3>
                    <p className='subtitle max-w-xl mx-auto xl:mx-0 text-sm md:text-base'>
                      I specialize in crafting intuitive websites with cutting
                      edge technology, and turning your ideas into reality.
                    </p>
                    {/* icons */}
                    ...
                    <div className='flex flex-col gap-y-2'>
                      ...
                      <span className='text-sm md:text-base'>
                        English, Tagalog, Bisaya, Chavacano
                      </span>
                    </div>
                  </div>
                </TabsContent>
